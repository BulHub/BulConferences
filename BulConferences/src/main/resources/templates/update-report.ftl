...
<div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4"
        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-7">
                    <h2 class="mb-0">Update report</h2>
    ...
    <form id="form4" autocomplete="off" method="post" action="/update/report">
        <div class="site-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="finish_date">Finish time</label>
...
<@main name="Update report &mdash; Website by BulConferences" nameCSS="developers.css"/>
